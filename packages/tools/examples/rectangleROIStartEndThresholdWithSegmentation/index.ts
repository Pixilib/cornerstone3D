...
async function run() {
  ...
  const isPreferredTargetId = (
    ...
    console.log(targetInfo.targetId, ptVolumeId);
    return targetInfo.targetId === ptVolumeId;
  };
  ...
  //'1.3.6.1.4.1.14519.5.2.1.7009.2403.3342406571319721368503433274 Original
